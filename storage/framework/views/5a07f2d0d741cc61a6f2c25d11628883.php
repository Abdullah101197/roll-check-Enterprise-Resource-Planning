                            ...
                            <li class="dash-item dash-hasmenu">
                                ...
                                <ul class="dash-submenu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Report')): ?>
                                        ...
                                        <li class="dash-item">
                                            <a class="dash-link"
                                                href="<?php echo e(route('report.employee.report')); ?>"><?php echo e(__('Employee Report')); ?></a>
                                        </li>
                                    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\roll-check\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>